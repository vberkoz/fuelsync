        ...
        <Dialog open={showForm} onClose={() => setShowForm(false)} className="relative z-50">
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4">
            <Dialog.Panel className="bg-slate-800 rounded-lg p-6 w-full max-w-md">
              <Dialog.Title className="text-xl font-bold text-white mb-4">Add Reminder</Dialog.Title>
              <form className="space-y-5">
                ...
                <Field>
                  <Label className="block text-sm font-semibold text-white mb-1.5">Type</Label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Field>
                    <Label className="block text-sm font-semibold text-white mb-1.5">Threshold</Label>
                    <input 
                      type="number" 
                  ...
                  <Field>
                    <Label className="block text-sm font-semibold text-white mb-1.5">Unit</Label>
          ...
          return (
            <div key={reminder.id} className={`bg-slate-800 p-6 rounded-lg border-2 ${
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                {isUrgent && (
                  <span className="px-2 py-1 bg-yellow-500/20 text-yellow-500 text-xs font-semibold rounded">Urgent</span>
                )}
              </div>
