...
export default function Settings() {
  ...
  const [formData, setFormData] = useState({ units: 'imperial', dateFormat: 'MM/DD/YYYY', notifications: true });
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-slate-800 rounded-lg p-6 max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-5">
          <Field>
            <Label className="block text-sm font-semibold text-white mb-1.5">Units</Label>
          ...
          <Field>
            <Label className="block text-sm font-semibold text-white mb-1.5">Date Format</Label>
